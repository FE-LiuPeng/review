...
- 如何编写 Loader ? 介绍一下思路？❗️❗️❗️
   手写webpack loader [掘金黄小虫](https://juejin.cn/post/6844904031240863758#heading-35)
    ...
    > 知识点普及之AST。AST通俗的来说，假设我们有一个文件a.js,我们对a.js里面的1000行进行一些操作处理,比如为所有的await 增加try catch,以及其他操作，但是a.js里面的代码本质上来说就是一堆字符串。那我们怎么办呢，那就是转换为带标记信息的对象(抽象语法树)我们方便进行增删改查。这个带标记的对象(抽象语法树)就是AST。这里推荐一篇不错的AST文章 [AST快速入门](https://link.juejin.cn/?target=https%3A%2F%2Fsegmentfault.com%2Fa%2F1190000016231512)
    ...
    **新建drop-console.js**
    ...
    如何使用
      ...
      ``` 
      附: [官网编写loder](https://webpack.docschina.org/contribute/writing-a-loader/)
- 如何编写 Plugin ? 介绍一下思路？❗️❗️❗️
    手写webpack plugin [掘金黄小虫](https://juejin.cn/post/6844904031240863758#heading-35)
